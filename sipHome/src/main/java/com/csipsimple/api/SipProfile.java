...
public class SipProfile implements Parcelable {
	...
	private static final String TAG = SipProfile.class.getSimpleName();
    ...
    public String toString(){
    	//Log.d(TAG, "this.toString: " + this.toString());
    	
    	return "account id: " + this.acc_id + 
    			"username: " + getSipUserName() +
    			"sip domain: " + getSipDomain() +
    			"password: " + getPassword() + 
    			"proxy Address: " + getProxyAddress() + 
