...
NDK_SYSROOT=$ANDROID_NDK/platforms/android-$NDK_PLATFORM_VERSION/arch-mips
NDK_UNAME=`uname -s | tr '[A-Z]' '[a-z]'`
NDK_TOOLCHAIN_BASE=$ANDROID_NDK/toolchains/mipsel-linux-android-4.4.3/prebuilt/$NDK_UNAME-x86
CC="$NDK_TOOLCHAIN_BASE/bin/mipsel-linux-android-gcc --sysroot=$NDK_SYSROOT"
LD=$NDK_TOOLCHAIN_BASE/bin/mipsel-linux-android-ld
