...
pj_status_t dlsym_stagefright(struct amr_data* amr_data){
    ...
    status = dlsym_stagefright_41(amr_data);
...
pj_status_t dlsym_stagefright_41(struct amr_data* amr_data){
    amr_data->libEncode = dlopen("libstagefright_soft_amrnbenc.so", RTLD_LAZY);
